...
export BOX_NAME=${BOX_NAME:-"opensuse/Leap-15.4.x86_64"}
...
export S3GW_REGISTRY=${S3GW_REGISTRY:-"ghcr.io/giubacc"}
export S3GW_IMAGE=${S3GW_IMAGE:-"s3gw"}
export S3GW_TAG=${S3GW_TAG:-"latest"}
export PROV_USER=${PROV_USER:-"vagrant"}

export K3S_VERSION=${K3S_VERSION:-"v1.25.10+k3s1"}
